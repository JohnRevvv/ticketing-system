...
func SendEndorserReassignedNotification(ticket models.CreateTicket, toEmail string, oldEndorser string, newEndorser string, submitterName string) error {
	...
	subject := "Ticket Reassigned To Another Endorser"
...
<div class="container">
  ...
  <div class="header">
    ...
    <p>The ticket previously assigned to you has been reassigned.</p>
  </div>
  ...
  <div class="ticket-box">
    ...
    <p><span class="label">Category:</span> %s</p>
    <p><span class="label">Priority:</span> %s</p>
    <p><span class="label">Reassigned By:</span> %s</p>
    <p><span class="label">New Endorser:</span> %s</p>
  </div>
...
`,
	...
	if err != nil {
		log.Println("Failed to send reassignment email:", err)
	}
